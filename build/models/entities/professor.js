...
let Professor = (() => {
    ...
    var Professor = _classThis = class {
        constructor() {
    ...
    (() => {
        ...
        __esDecorate(null, null, _senha_decorators, { kind: "field", name: "senha", static: false, private: false, access: { has: obj => "senha" in obj, get: obj => obj.senha, set: (obj, value) => { obj.senha = value; } } }, _senha_initializers, _instanceExtraInitializers);
